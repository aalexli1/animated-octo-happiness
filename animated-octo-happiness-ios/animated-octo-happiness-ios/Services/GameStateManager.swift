...
class GameStateManager: ObservableObject {
    ...
    func recordTreasureDiscovery(_ treasure: Treasure) {
        ...
        // Fixed: Treasure doesn't have type property, using default score
        playerStats.totalScore += 50 // Default points
        
        // Type-specific tracking would require ARTreasure or adding type to Treasure model
