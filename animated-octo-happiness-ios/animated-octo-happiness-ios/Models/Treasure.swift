...
extension Treasure {
    enum CodingKeys: String, CodingKey {
        case id, title, treasureDescription, latitude, longitude, timestamp
        case isCollected, notes, imageData, emoji, createdBy
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        self.treasureDescription = try container.decode(String.self, forKey: .treasureDescription)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(treasureDescription, forKey: .treasureDescription)
